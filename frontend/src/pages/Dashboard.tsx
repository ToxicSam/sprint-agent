...
export default function Dashboard() {
  ...
  const clearBoardError = useStore(s => s.clearBoardError);
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      {boardError && (
        <div className="mx-4 mt-2 px-4 py-2 rounded-md bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 text-sm flex items-center justify-between">
          <span>{boardError}</span>
          <button onClick={clearBoardError} className="text-red-500 hover:text-red-700 font-medium">Dismiss</button>
        </div>
      )}
