...
const DEMO_FEEDBACK: RetroItemData[] = [
  { id: 'rf-1', category: 'liked', text: 'Standup efficiency improved — table mode is much faster', votes: 4, votedByMe: false },
  { id: 'rf-2', category: 'liked', text: 'Agent integration feels natural now', votes: 3, votedByMe: false },
  { id: 'rf-3', category: 'liked', text: 'Task creation is instant with inline form', votes: 3, votedByMe: true },
  { id: 'rf-4', category: 'liked', text: 'Dark mode is easy on the eyes', votes: 2, votedByMe: false },
  { id: 'rf-5', category: 'disliked', text: 'Some API calls still fail silently', votes: 3, votedByMe: false },
  { id: 'rf-6', category: 'disliked', text: 'Mobile drag-and-drop needs work', votes: 2, votedByMe: false },
  { id: 'rf-7', category: 'action', text: 'Add error handling to all API calls', votes: 2, votedByMe: false },
  { id: 'rf-8', category: 'action', text: 'Test mobile DnD on iOS Safari', votes: 1, votedByMe: false },
  { id: 'rf-9', category: 'action', text: 'Document keyboard shortcuts in onboarding', votes: 1, votedByMe: false },
];
...
export default function Retro() {
  ...
  /* Feedback items */
  const [items, setItems] = useState<RetroItemData[]>(DEMO_FEEDBACK);
